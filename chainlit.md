...
* **Watchlist Management**: I can create, view, and manage custom watchlists of stocks, allowing you to track securities you are interested in.
...
* `create_new_watchlist`: Create a new list of stocks.
* `get_all_my_watchlists`: See all the watchlists you've created.
* `get_watchlist_details`: Look inside a specific watchlist.
* `add_symbol_to_existing_watchlist`: Add a new stock to a list.
* `remove_symbol_from_existing_watchlist`: Remove a stock from a list.
* `rename_watchlist`: Change the name of a watchlist.
* `delete_existing_watchlist`: Permanently remove a watchlist.
